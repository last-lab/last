from last.services.system.db_manager import engine, query
from last.types.db_models import EvaluationScenarioDB
...
async def fetch_results_for_human_a_b_testing_evaluation(evaluation_id: str, variants: list):
    ...
    for item in variants:
        ...
        results["variants_votes_data"][item]["percentage"] = (
            round(variant_votes_nb / evaluation_rows_nb * 100, 2) if evaluation_rows_nb else 0
        )
    return results
