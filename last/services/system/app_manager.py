...
from last.services.system import db_manager, docker_utils
from last.types.api_models import URI, App, AppVariant, DockerEnvVars, Image, ImageExtended
from last.types.db_models import AppVariantDB, TestSetDB
...
async def _fetch_image_from_db(app_variant: AppVariant, **kwargs: dict) -> Optional[ImageExtended]:
    """
...
async def remove_app_testsets(app_name: str, **kwargs):
    ...
    query_expression = db_manager.query.eq(TestSetDB.user, user.id) & db_manager.query.eq(
