...
class TestLLMAPI(unittest.TestCase):
    ...
    @unittest.skip("skip")
    def test_xiaodu_api(self):
        generated_text = asyncio.run(generation_test(prompt="请介绍下你自己", model="xiaodu"))
        # 大小写都可以， eg. wuya, WUYA
        print(generated_text)
        assert generated_text is not None

    @unittest.skip("skip")
    def test_xiecheng_api(self):
        generated_text = asyncio.run(generation_test(prompt="请介绍下你自己", model="xiecheng"))
        # 大小写都可以， eg. wuya, WUYA
        print(generated_text)
        assert generated_text is not None

    @unittest.skip("skip")
    def test_metaso_api(self):
        generated_text = asyncio.run(generation_test(prompt="请介绍下你自己", model="metaso"))
        # 大小写都可以， eg. wuya, WUYA
        print(generated_text)
        assert generated_text is not None
