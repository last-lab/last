...
class DataSet(Model):
    name = fields.CharField(max_length=200)
    focused_risks = fields.TextField(null=True)
    ...
    used_by = fields.IntField(null=True)
    qa_num = fields.IntField(null=True)
    word_cnt = fields.IntField(null=True)
    updated_at = fields.CharField(max_length=200, null=True)
    qa_records = fields.TextField(null=True)
    conversation_start_id = fields.TextField(null=True)
